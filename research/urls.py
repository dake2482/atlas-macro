...
urlpatterns = [
    ...
    path("assets/equities/", views.dashboard_page, {"page_key": "assets-equities"}, name="equities"),
    ...
    path("assets/commodities/", views.dashboard_page, {"page_key": "assets-commodities"}, name="commodities"),
    ...
    path("rates/yield-curve/", views.dashboard_page, {"page_key": "yield-curve"}, name="yield-curve"),
    ...
    path("rates/expectations/", views.dashboard_page, {"page_key": "expectations"}, name="expectations"),
    path("fed/", views.fed_hub, name="fed-hub"),
    path("fed/statements/", views.fed_list, {"doc_type": "statement"}, name="fed-statements"),
    path("fed/statements/<slug:slug>/", views.fed_detail, {"doc_type": "statement"}, name="fed-detail"),
    path("fed/speeches/", views.fed_list, {"doc_type": "speech"}, name="fed-speeches"),
    path("fed/speeches/<slug:slug>/", views.fed_detail, {"doc_type": "speech"}, name="fed-speech-detail"),
    ...
    path("fed/hawkish-dovish/", views.dashboard_page, {"page_key": "fed-hawkish-dovish"}, name="hawkish-dovish"),
    path("liquidity/", views.dashboard_page, {"page_key": "liquidity"}, name="liquidity-overview"),
    path("liquidity/transmission-chain/", views.dashboard_page, {"page_key": "transmission-chain"}, name="transmission-chain"),
    path("liquidity/fed-balance-sheet/", views.dashboard_page, {"page_key": "fed-balance-sheet"}, name="fed-balance-sheet"),
    path("liquidity/operations/", views.dashboard_page, {"page_key": "operations"}, name="operations"),
    ...
    path("liquidity/global-dollar/", views.dashboard_page, {"page_key": "global-dollar"}, name="global-dollar"),
    path("liquidity/subsurface/", views.dashboard_page, {"page_key": "subsurface"}, name="subsurface"),
    ...
    path("economy/employment/", views.dashboard_page, {"page_key": "employment"}, name="employment"),
    ...
    path("volatility/", views.dashboard_page, {"page_key": "volatility"}, name="volatility-overview"),
    path("volatility/dashboard/", views.dashboard_page, {"page_key": "volatility-dashboard"}, name="volatility-dashboard"),
    path("volatility/vix/", views.dashboard_page, {"page_key": "vix"}, name="vix"),
    path("volatility/move/", views.dashboard_page, {"page_key": "volatility-move"}, name="volatility-move"),
    path("volatility/fx-vol/", views.dashboard_page, {"page_key": "fx-vol"}, name="fx-vol"),
    path("volatility/implied-vs-realized/", views.dashboard_page, {"page_key": "implied-vs-realized"}, name="implied-vs-realized"),
    path("credit/", views.dashboard_page, {"page_key": "credit"}, name="credit-overview"),
    path("credit/spreads/", views.dashboard_page, {"page_key": "credit-spreads"}, name="credit-spreads"),
    path("credit/cds/", views.dashboard_page, {"page_key": "credit-cds"}, name="credit-cds"),
    path("credit/stress/", views.dashboard_page, {"page_key": "credit-stress"}, name="credit-stress"),
    path("credit/issuance/", views.gone, {"reason": "一级信用发行模块已重构下线；取得可靠发行数据许可后再启用。"}, name="credit-issuance"),
    path("credit/events/", views.gone, {"reason": "信用事件页因缺少结构化评级授权数据而下线。"}, name="credit-events"),
    path("news/", views.news_list, name="news"),
    path("semiconductor-news/", views.news_list, {"semiconductor_only": True}, name="semiconductor-news"),
    ...
    path("supply-chain/foundry/", views.dashboard_page, {"page_key": "supply-chain-foundry"}, name="supply-chain-foundry"),
    path("supply-chain/packaging/", views.dashboard_page, {"page_key": "supply-chain-packaging"}, name="supply-chain-packaging"),
    path("supply-chain/hbm/", views.dashboard_page, {"page_key": "supply-chain-hbm"}, name="supply-chain-hbm"),
    path("supply-chain/gpu/", views.dashboard_page, {"page_key": "supply-chain-gpu"}, name="supply-chain-gpu"),
    path("supply-chain/demand/", views.dashboard_page, {"page_key": "supply-chain-demand"}, name="supply-chain-demand"),
    ...
    path("ai-industry/chain/semiconductor-manufacturing/", views.ai_hub, {"chain_mode": True}, name="semiconductor-chain"),
    path("ai-industry/chain/semiconductor-manufacturing/<slug:slug>/", views.ai_node, name="ai-node"),
    ...
    path("ai-industry/chain/model-evolution/model/<slug:slug>/", views.model_detail, name="model-detail"),
    path("ai-industry/vibe-coding/<slug:slug>/", views.coding_agent_detail, name="coding-agent-detail"),
